    ...
    return(
        <>
            <div className='form-wrapper  p-3'>
                <h3 className='text-C'>Contact us.</h3>
                <p className='width-50 text-platinum'>
                ...
                <div className='row g-4'>
                    <div className='col-md-8  width-50'>
                        <form onSubmit={ handleSubmit }>
                            <div className='form-group mb-4 text-platinum'>
                    ...
                    <div className='col-md-4'>
                        ...
                        <ul className='p-0'>
                            <li className='list-group-item mb-3 text-platinum'>
